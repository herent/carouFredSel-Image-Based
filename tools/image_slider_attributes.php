...
if (intval($_GET['uID']) > 0 && intval($_GET['fID']) > 0) {
	...
	if ($setAttribs) {
		...
		<div class="caroufredsel-btn-wrap">
			<a class="cancel caroufredsel-btn" id="attributes-form-cancel"><?php echo t("Cancel"); ?></a>
			<a class="primary caroufredsel-btn" id="attributes-form-save"><?php echo t("Save Attributes"); ?></a>
		</div>
	<?php
	}
} else {
